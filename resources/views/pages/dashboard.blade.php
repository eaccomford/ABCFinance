                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-end">
                                            ...
                                            <div class="dashboard-content-right">
                                                <img src="{{asset('admin')}}/app-assets/images/icon/cup.png" height="220" width="220" class="img-fluid" alt="Dashboard Ecommerce" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-10.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                    ...
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-12.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-9.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-25.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                                    <h6 class="media-heading mb-0">Pauly Dez</h6>
                                                                    <span class="font-small-2">Devloper</span>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-16.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-1.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                                    <h6 class="media-heading mb-0">Pauly Dez</h6>
                                                                    <span class="font-small-2">Devloper</span>
                                                    ...
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-2.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pr-75">
                                                            <div class="media align-items-center">
                                                                <a class="media-left mr-50" href="#">
                                                                    <img src="{{asset('admin')}}/app-assets/images/portrait/small/avatar-s-19.jpg" alt="avatar" class="rounded-circle" height="30" width="30">
                                                                </a>
                                                                <div class="media-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="py-1 line-ellipsis">
                                                    <img class="rounded-circle mr-1" src="{{asset('admin')}}/app-assets/images/icon/fs.png" alt="card" height="24" width="24">Fastrack Watches
                                                </td>
                                                <td class="py-1">
                                            ...
                                            <tr>
                                                <td class="py-1 line-ellipsis">
                                                    <img class="rounded-circle mr-1" src="{{asset('admin')}}/app-assets/images/icon/puma.png" alt="card" height="24" width="24">Puma Shoes
                                                </td>
                                                <td class="py-1">
                                            ...
                                            <tr>
                                                <td class="py-1 line-ellipsis">
                                                    <img class="rounded-circle mr-1" src="{{asset('admin')}}/app-assets/images/icon/nike.png" alt="card" height="24" width="24">Nike Air Jordan
                                                </td>
                                                <td class="py-1">
                                            ...
                                            <tr>
                                                <td class="py-1 line-ellipsis">
                                                    <img class="rounded-circle mr-1" src="{{asset('admin')}}/app-assets/images/icon/one-plus.png" alt="card" height="24" width="24">Oneplus 7 pro
                                                </td>
                                                <td class="py-1">
                                            ...
                                            <tr>
                                                <td class="py-1 line-ellipsis">
                                                    <img class="rounded-circle mr-1" src="{{asset('admin')}}/app-assets/images/icon/google.png" alt="card" height="24" width="24">Google Pixel 4 xl
                                                </td>
